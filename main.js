...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `𝗗𝗮𝗿𝗰𝗼 𝗮𝗻𝗱 𝘃𝗮𝗺𝗽𝗶𝗿𝗲 𝗯𝗼𝘁`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝗗𝗮𝗿𝗰𝗼 𝗮𝗻𝗱 𝘃𝗮𝗺𝗽𝗶𝗿𝗲 𝗯𝗼𝘁`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
